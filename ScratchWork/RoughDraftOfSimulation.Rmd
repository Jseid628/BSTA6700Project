...
# The functions I will use. Morph reshapes the data, lq fits my model
...
factor_sim <- function(model,n,trt,k_total,t_total,variance, morph_mod, lq_mod, num_timepoints=NULL) {
...
for (setting in settings_list) {
  ...
  for (s in 1:n_sim) {
    ...
    result <- factor_sim(model, n, trt, k_total, t_total, variance=1, morph_mod = morph, lq_mod = lq, num_timepoints=40)
...
Reticulate does not work with Mclapply.
Do 1000 MC simulations.
